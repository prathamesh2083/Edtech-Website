...
export default function Card({card}) {
  ...
  return (
    <div className="aspect-square min-w-[300px] aspect-retangle w-[30%] flex flex-col justify-center gap-3 flex-wrap bg-richblack-800 px-6 hover:scale-105 transition-all duration-500">
